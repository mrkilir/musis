        ...
        ░  ░  ░  ░ ░░ ░    ░          ░░   ░   ░   ▒   ░        ░ ░░ ░    ░     ░░   ░ 
              ░  ░  ░      ░ ░         ░           ░  ░░ ░      ░  ░      ░  ░   ░     
                           ░                           ░                               
                             ...
                             ╔═══════════════════════════════════
                             ║          ► Options               ║
                             ║    • Generate IP list (80) [1]   ║
                             ║    • Generate IP list (8080) [2] ║
                             ║    • crate by:                   ║
                             ║      @ThePain_Official║
                             ╚═══════════════════════════════════    """)


    selection = input("plasee select Options:"+ white)
...
def genip():
    ...
    print(green + 'Enter number ip for generate Maximum 999999')

    nips = input("Enter number:" + white)

    print(green + 'Wait to generate...')
    ...
    for i in range(0, int(nips)):
        ...
        ip = str(a) + '.' + str(b) + '.' + str(c) + '.' + str(d) + ":80"
        open('http80.txt', 'a').write(ip+'\n')

    clear()

    print(green + 'Successful name file http80.txt saved')

    print("Returning to the main menu. in 7 Seconds....")
...
def genenv():
    ...
    for i in range(0, int(nips)):
        ...
        c = random.randrange(0, 255, 1)
        d = random.randrange(0, 255, 1)
        ip = str(a) + '.' + str(b) + '.' + str(c) + '.' + str(d) + ":8080"
        open('http8080.txt', 'a').write(ip+'\n')

    clear()

    print(green + "Successful name file http8080.txt saved")
